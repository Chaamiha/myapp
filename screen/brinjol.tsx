  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.imageContainer}>
        <Image 
          source={{ uri: "https://th.bing.com/th/id/OIP.4NhFKDOtBEWoLE6k05d48AHaEX?rs=1&pid=ImgDetMain" }} 
          style={styles.image} 
        />
      </View>

      <View style={styles.detailsContainer}>
        <Text style={styles.title}>BRINJOL PLANT</Text>
        <View style={styles.ratingContainer}>
          ...
          <Text style={styles.ratingText}>Growing BRINJOL Plant</Text>
        </View>
...
Indoor gardening? Try LED grow lights or a hydroponic system for better results.
        ...
        <View style={styles.infoContainer}>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoValue}>BRINJOL</Text>
          </View>
          <View style={styles.infoBox}>
