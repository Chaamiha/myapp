  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.imageContainer}>
        <Image 
          source={{ uri: "https://th.bing.com/th/id/R.f9840ca970a9b2391bcd3ef400ce9850?rik=guGydkB7isV6WA&pid=ImgRaw&r=0" }} 
          style={styles.image} 
        />
      </View>

      <View style={styles.detailsContainer}>
        <Text style={styles.title}>Beets PLANT</Text>
        <View style={styles.ratingContainer}>
          ...
          <Text style={styles.ratingText}>Growing Beets Plant</Text>
        </View>
...
Indoor gardening? Try LED grow lights or a hydroponic system for better results.
        ...
        <View style={styles.infoContainer}>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoValue}>Beets</Text>
          </View>
          <View style={styles.infoBox}>
