  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.imageContainer}>
        <Image 
          source={{ uri: "https://healthsea.com/wp-content/uploads/2023/10/cucumber-what-is-growing-types-and-health-properties-493505.jpg" }} 
          style={styles.image} 
        />
      </View>

      <View style={styles.detailsContainer}>
        <Text style={styles.title}>CUCUCMBER</Text>
        <View style={styles.ratingContainer}>
          ...
          <Text style={styles.ratingText}>Growing CUCUCMBER Plant</Text>
        </View>
...
Indoor gardening? Try LED grow lights or a hydroponic system for better results.
        ...
        <View style={styles.infoContainer}>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoValue}>CUCUCMBER</Text>
          </View>
          <View style={styles.infoBox}>
